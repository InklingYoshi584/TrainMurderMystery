...
import dev.doctor4t.wathe.game.gamemode.RandomGameMode;
...
public class WatheGameModes {
    ...
    public static final Identifier RANDOM_ID = Wathe.id("random");
    ...
    public static final GameMode RANDOM = registerGameMode(RANDOM_ID, new RandomGameMode(RANDOM_ID));
